...
the ability to communicate with executive stakeholders.`},site:{url:"https://jodybro.github.io",name:"Amar Sattaur Portfolio"},employer:{name:"Mogo Financial"},keywords:["DevOps Engineer","Platform Engineer","Staff Engineer","Kubernetes","EKS","ArgoCD","Terraform","AWS","GCP","Oracle Cloud","CI/CD","Infrastructure","SRE","GitHub Actions"],knowsAbout:["Kubernetes","Amazon EKS","Google GKE","ArgoCD","Terraform","GitHub Actions","CI/CD","DevOps","Platform Engineering","Cloud Infrastructure","AWS","GCP","Oracle Cloud"]};e.s(["siteConfig",0,s])},12395,e=>{"use strict";let s=[{slug:"zero-downtime-eks-upgrades",title:"Zero-Downtime EKS Upgrades: A Complete Guide",excerpt:"Learn how to upgrade EKS clusters across multiple major versions while maintaining 100% uptime. Covers API deprecation audits, Helm chart migrations, and validation procedures.",date:"January 2025",dateValue:new Date("2025-01-15"),readTime:"12 min read",readTimeMinutes:12,tags:["Kubernetes","EKS","DevOps"],icon:"bi-journal-code"},{slug:"reusable-github-actions-workflows",title:"Building Reusable GitHub Actions Workflows",excerpt:"How to design CI/CD pipeline frameworks that reduce onboarding time from days to hours. Includes Docker layer caching, conditional triggers, and GHCR publishing patterns.",date:"December 2024",dateValue:new Date("2024-12-15"),readTime:"8 min read",readTimeMinutes:8,tags:["GitHub Actions","CI/CD","Automation"],icon:"bi-gear-wide-connected"},{slug:"argocd-multi-cluster-patterns",title:"ArgoCD Multi-Cluster Deployment Patterns",excerpt:"Architecting centralized GitOps governance using the control plane model for managing multiple downstream ArgoCD instances across environments.",date:"November 2024",dateValue:new Date("2024-11-15"),readTime:"10 min read",readTimeMinutes:10,tags:["ArgoCD","GitOps","Kubernetes"],icon:"bi-diagram-3"}],t=[{title:"AWS to Oracle Cloud Migration",company:"Mogo Financial",challenge:"Migrate entire production infrastructure from AWS to Oracle Cloud Infrastructure with minimal downtime and no service disruption.",solution:"Designed comprehensive migration strategy including parallel infrastructure provisioning, data synchronization, and phased cutover procedures. Implemented Terraform modules for OCI resources and established network connectivity between clouds during transition.",results:["Zero unplanned downtime during migration","30% reduction in infrastructure costs","Improved disaster recovery posture"],technologies:["AWS","Oracle Cloud","Terraform","Kubernetes","ArgoCD"],icon:"bi-cloud-arrow-up"},{title:"CI/CD Pipeline Standardization",company:"Multiple Organizations",challenge:"Development teams spending days configuring CI/CD pipelines for new services, leading to inconsistent deployments and security gaps.",solution:"Built reusable GitHub Actions workflow templates with built-in security scanning, Docker layer caching, and automated versioning. Created comprehensive documentation and self-service onboarding guides.",results:["Service onboarding reduced from days to hours","35% faster build times","Consistent security posture across all services"],technologies:["GitHub Actions","Docker","semantic-release","Trivy"],icon:"bi-arrow-repeat"},{title:"Kubernetes Platform Modernization",company:"Narvar",challenge:"Legacy deployment process using raw kubectl commands with no GitOps practices, leading to configuration drift and deployment failures.",solution:"Implemented self-managed ArgoCD with application sets, authored base Helm charts with JSON Schema validation, and established GitOps workflows with automated image updates.",results:["100% GitOps adoption across teams","90% reduction in deployment-related incidents","Automated rollbacks and audit trails"],technologies:["ArgoCD","Helm","Kubernetes","CircleCI"],icon:"bi-rocket-takeoff"}];function a(){let e=new Set;return s.forEach(s=>s.tags.forEach(s=>e.add(s))),t.forEach(s=>s.technologies.forEach(s=>e.add(s))),Array.from(e).sort()}e.s(["blogPosts",0,s,"caseStudies",0,t,"getAllTags",()=>a])},62319,e=>{"use strict";var s=e.i(43476),t=e.i(71645),a=e.i(22016),n=e.i(12395);function r({activePage:r="home"}){let[i,l]=(0,t.useState)(!0),[o,c]=(0,t.useState)(!1),[d,m]=(0,t.useState)(""),[u,h]=(0,t.useState)([]),p=(0,t.useRef)(null),g=(0,t.useMemo)(()=>(0,n.getAllTags)(),[]),f=(0,t.useMemo)(()=>{let e=d.toLowerCase().trim(),s=[];return n.blogPosts.forEach(t=>{let a=!e||t.title.toLowerCase().includes(e)||t.excerpt.toLowerCase().includes(e)||t.tags.some(s=>s.toLowerCase().includes(e)),n=0===u.length||u.some(e=>t.tags.includes(e));a&&n&&s.push({type:"blog",title:t.title,description:t.excerpt,tags:t.tags,link:`/blog/${t.slug}`,icon:t.icon})}),n.caseStudies.forEach(t=>{let a=!e||t.title.toLowerCase().includes(e)||t.challenge.toLowerCase().includes(e)||t.technologies.some(s=>s.toLowerCase().includes(e)),n=0===u.length||u.some(e=>t.technologies.includes(e));a&&n&&s.push({type:"case-study",title:t.title,description:t.challenge,tags:t.technologies,link:"/#case-studies",icon:t.icon})}),s},[d,u]),x=(0,t.useCallback)(e=>{h(s=>s.includes(e)?s.filter(s=>s!==e):[...s,e])},[]);(0,t.useEffect)(()=>{let e=e=>{p.current&&!p.current.contains(e.target)&&c(!1)};return document.addEventListener("mousedown",e),()=>document.removeEventListener("mousedown",e)},[]),(0,t.useEffect)(()=>{e.A(54445);let s=localStorage.getItem("theme");s&&l("dark"===s)},[]),(0,t.useEffect)(()=>{document.documentElement.setAttribute("data-theme",i?"dark":"light"),localStorage.setItem("theme",i?"dark":"light")},[i]);let v=(0,t.useCallback)(()=>{l(e=>!e)},[]),b="home"===r;return(0,s.jsx)("nav",{className:"navbar navbar-expand-lg fixed-top",children:(0,s.jsxs)("div",{className:"container",children:[(0,s.jsxs)(a.default,{className:"navbar-brand text-info",href:"/",children:[(0,s.jsx)("i",{className:"bi bi-terminal me-2"}),"amarsattaur"]}),(0,s.jsx)("button",{className:"navbar-toggler border-0",type:"button","data-bs-toggle":"collapse","data-bs-target":"#navbarNav","aria-controls":"navbarNav","aria-expanded":"false","aria-label":"Toggle navigation",children:(0,s.jsx)("i",{className:"bi bi-list text-light fs-4"})}),(0,s.jsxs)("div",{className:"collapse navbar-collapse",id:"navbarNav",children:[(0,s.jsxs)("ul",{className:"navbar-nav ms-auto nav-compact",children:[(0,s.jsx)("li",{className:"nav-item",children:(0,s.jsx)(a.default,{className:`nav-link ${"home"===r?"active":""}`,href:b?"#about":"/#about",children:"About"})}),(0,s.jsx)("li",{className:"nav-item",children:(0,s.jsx)(a.default,{className:"nav-link",href:b?"#experience":"/#experience",children:"Experience"})}),(0,s.jsxs)("li",{className:"nav-item dropdown",children:[(0,s.jsx)("a",{className:`nav-link dropdown-toggle ${"blog"===r?"active":""}`,href:"#",role:"button","data-bs-toggle":"dropdown","aria-expanded":"false",children:"Content"}),(0,s.jsxs)("ul",{className:"dropdown-menu",children:[(0,s.jsx)("li",{children:(0,s.jsxs)(a.default,{className:"dropdown-item",href:"/blog",children:[(0,s.jsx)("i",{className:"bi bi-journal-text me-2"}),"Blog"]})}),(0,s.jsx)("li",{children:(0,s.jsxs)(a.default,{className:"dropdown-item",href:b?"#case-studies":"/#case-studies",children:[(0,s.jsx)("i",{className:"bi bi-briefcase me-2"}),"Case Studies"]})})]})]}),(0,s.jsx)("li",{className:"nav-item",children:(0,s.jsx)(a.default,{className:`nav-link ${"incidents"===r?"active":""}`,href:"/incidents",children:"Incidents"})}),(0,s.jsx)("li",{className:"nav-item",children:(0,s.jsx)(a.default,{className:"nav-link",href:b?"#contact":"/#contact",children:"Contact"})})]}),(0,s.jsxs)("div",{className:"search-container ms-lg-2 mt-3 mt-lg-0",ref:p,children:[(0,s.jsx)("button",{className:"btn nav-icon-btn",onClick:()=>c(!o),"aria-label":"Search",children:(0,s.jsx)("i",{className:"bi bi-search"})}),o&&(0,s.jsxs)("div",{className:"search-dropdown",children:[(0,s.jsxs)("div",{className:"search-input-container",children:[(0,s.jsx)("i",{className:"bi bi-search search-icon"}),(0,s.jsx)("input",{type:"text",className:"search-input-full",placeholder:"Search posts & case studies...",value:d,onChange:e=>m(e.target.value),autoFocus:!0}),(d||u.length>0)&&(0,s.jsx)("button",{className:"search-clear",onClick:()=>{m(""),h([])},"aria-label":"Clear search and filters",title:"Clear search and filters",children:(0,s.jsx)("i",{className:"bi bi-x","aria-hidden":"true"})})]}),(0,s.jsxs)("div",{className:"search-tags",children:[(0,s.jsx)("span",{className:"search-tags-label",children:"Filter by tag:"}),(0,s.jsx)("div",{className:"search-tags-list",children:g.map(e=>(0,s.jsx)("button",{className:`search-tag ${u.includes(e)?"active":""}`,onClick:()=>x(e),children:e},e))})]}),(0,s.jsxs)(a.default,{href:`/search${u.length>0?`?tags=${u.join(",")}`:""}${d?`${u.length>0?"&":"?"}q=${encodeURIComponent(d)}`:""}`,className:"search-view-all-primary",onClick:()=>c(!1),children:[(0,s.jsx)("i",{className:"bi bi-grid-3x3-gap me-2"}),"View All Posts & Case Studies",(0,s.jsx)("i",{className:"bi bi-arrow-right ms-2"})]}),(0,s.jsx)("div",{className:"search-results",children:f.length>0?(0,s.jsxs)(s.Fragment,{children:[(0,s.jsxs)("div",{className:"search-results-label",children:[f.length," ",1===f.length?"result":"results"," found"]}),f.slice(0,3).map((e,t)=>(0,s.jsxs)(a.default,{href:e.link,className:"search-result-item",onClick:()=>c(!1),children:[(0,s.jsx)("div",{className:"search-result-icon",children:(0,s.jsx)("i",{className:`bi ${e.icon}`})}),(0,s.jsxs)("div",{className:"search-result-content",children:[(0,s.jsx)("div",{className:"search-result-type",children:"blog"===e.type?"Blog Post":"Case Study"}),(0,s.jsx)("div",{className:"search-result-title",children:e.title}),(0,s.jsx)("div",{className:"search-result-tags",children:e.tags.slice(0,3).map(e=>(0,s.jsx)("span",{className:"search-result-tag",children:e},e))})]})]},t))]}):(0,s.jsxs)("div",{className:"search-no-results",children:[(0,s.jsx)("i",{className:"bi bi-search me-2"}),d||u.length>0?"No results found":"Type to search or select tags to filter"]})})]})]}),(0,s.jsx)("button",{onClick:v,className:"btn nav-icon-btn ms-lg-2 mt-3 mt-lg-0","aria-label":"Toggle theme",children:(0,s.jsx)("i",{className:`bi ${i?"bi-sun":"bi-moon-stars"}`})}),(0,s.jsxs)("div",{className:"btn-group ms-lg-2 mt-3 mt-lg-0",children:[(0,s.jsxs)(a.default,{href:"/resume",className:"btn btn-resume",children:[(0,s.jsx)("i",{className:"bi bi-file-earmark-text me-1"}),"Resume"]}),(0,s.jsx)("button",{type:"button",className:"btn btn-resume dropdown-toggle dropdown-toggle-split","data-bs-toggle":"dropdown","aria-expanded":"false",children:(0,s.jsx)("span",{className:"visually-hidden",children:"Toggle Dropdown"})}),(0,s.jsx)("ul",{className:"dropdown-menu dropdown-menu-end",children:(0,s.jsx)("li",{children:(0,s.jsxs)("a",{className:"dropdown-item",href:"/Amar_Sattaur_Resume.pdf",download:!0,children:[(0,s.jsx)("i",{className:"bi bi-download me-2"}),"Download"]})})})]})]})]})})}e.s(["default",()=>r])},49255,e=>{"use strict";var s=e.i(43476),t=e.i(22016),a=e.i(18178),n=e.i(62319);function r(){return(0,s.jsxs)(s.Fragment,{children:[(0,s.jsx)(n.default,{activePage:"blog"}),(0,s.jsx)("article",{className:"py-5",style:{paddingTop:"120px"},children:(0,s.jsx)("div",{className:"container py-5",children:(0,s.jsx)("div",{className:"row",children:(0,s.jsxs)("div",{className:"col-lg-8 mx-auto",children:[(0,s.jsx)("nav",{"aria-label":"breadcrumb",className:"mb-4",children:(0,s.jsxs)("ol",{className:"breadcrumb",children:[(0,s.jsx)("li",{className:"breadcrumb-item",children:(0,s.jsx)(t.default,{href:"/",className:"text-info",children:"Home"})}),(0,s.jsx)("li",{className:"breadcrumb-item",children:(0,s.jsx)(t.default,{href:"/blog",className:"text-info",children:"Blog"})}),(0,s.jsx)("li",{className:"breadcrumb-item active text-secondary",children:"Production CI/CD"})]})}),(0,s.jsxs)("header",{className:"mb-5",children:[(0,s.jsxs)("div",{className:"d-flex flex-wrap gap-2 mb-3",children:[(0,s.jsx)("span",{className:"tech-badge",children:"GitHub Actions"}),(0,s.jsx)("span",{className:"tech-badge",children:"CI/CD"}),(0,s.jsx)("span",{className:"tech-badge",children:"Helm"}),(0,s.jsx)("span",{className:"tech-badge",children:"ArgoCD"}),(0,s.jsx)("span",{className:"tech-badge",children:"Release Please"})]}),(0,s.jsx)("h1",{className:"display-5 fw-bold mb-3",children:"Building a Production-Ready CI/CD Pipeline with Reusable GitHub Actions"}),(0,s.jsxs)("div",{className:"d-flex align-items-center text-secondary",children:[(0,s.jsx)("span",{children:"January 2025"}),(0,s.jsx)("span",{className:"mx-2",children:"•"}),(0,s.jsx)("span",{children:"15 min read"})]})]}),(0,s.jsxs)("div",{className:"blog-content",children:[(0,s.jsx)("p",{className:"lead text-secondary mb-4",children:"When your organization scales from a handful of services to 20+ microservices, copy-pasting CI/CD configurations becomes unsustainable. This post walks through a production-ready pipeline architecture that uses reusable workflows, environment-aware deployments, and GitOps integration with ArgoCD."}),(0,s.jsx)("h2",{className:"h3 mt-5 mb-3 text-info",children:"The Scenario"}),(0,s.jsx)("p",{className:"text-secondary",children:"Imagine a growing fintech startup—let's call them Acme Corp—that started with a monolith and gradually broke it into microservices. As the engineering team expanded, they faced common CI/CD challenges:"}),(0,s.jsxs)("ul",{className:"text-secondary",children:[(0,s.jsx)("li",{children:"Each team copied pipeline configs from existing repos, leading to drift"}),(0,s.jsx)("li",{children:"Inconsistent Helm chart naming conventions (hyphens vs underscores, casing issues)"}),(0,s.jsx)("li",{children:"No clear process for multi-environment deployments (dev, staging, prod)"}),(0,s.jsx)("li",{children:"Ad-hoc version bumping with no correlation to change significance"}),(0,s.jsx)("li",{children:"ArgoCD sync happening manually or with inconsistent automation"})]}),(0,s.jsx)("p",{className:"text-secondary",children:"The solution? A centralized reusable workflow that handles the entire build-to-deploy lifecycle with a single tag push."}),(0,s.jsx)("h2",{className:"h3 mt-5 mb-3 text-info",children:"Architecture Overview"}),(0,s.jsx)("p",{className:"text-secondary",children:"The pipeline uses a caller/callee pattern where individual service repos have minimal configuration, and a centralized workflow handles all the complexity."}),(0,s.jsxs)("div",{className:"custom-card p-4 my-4",children:[(0,s.jsxs)("h5",{className:"text-info mb-3",children:[(0,s.jsx)("i",{className:"bi bi-diagram-3 me-2"}),"Pipeline Flow"]}),(0,s.jsx)("pre",{className:"text-success mb-0",style:{fontSize:"0.85rem"},children:`Developer pushes tag: deploy-staging-v1.2.3
                    ↓
┌─────────────────────────────────────────────────────────────────┐
