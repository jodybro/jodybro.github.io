...
│         ↓                                                       │
│  Job 3: update-values  → Update env-specific values in oci branch│
│         ↓                                                       │
...
jobs:
  ...
  run: |
    ...
    fi`})})]}),(0,t.jsx)("h3",{className:"h5 mt-4 mb-3",children:"Auto-Versioning & OCI Push"}),(0,t.jsx)("p",{className:"text-secondary",children:"The workflow automatically increments the patch version to prevent collisions, then publishes to GHCR as an OCI artifact."}),(0,t.jsxs)("div",{className:"terminal-card my-4",children:[(0,t.jsxs)("div",{className:"terminal-header",children:[(0,t.jsx)("div",{className:"terminal-dot terminal-dot-red"}),(0,t.jsx)("div",{className:"terminal-dot terminal-dot-yellow"}),(0,t.jsx)("div",{className:"terminal-dot terminal-dot-green"}),(0,t.jsx)("span",{className:"ms-3 text-secondary small",children:"Version and push Helm chart"})]}),(0,t.jsx)("div",{className:"terminal-body",children:(0,t.jsx)("pre",{className:"text-success mb-0",children:`- name: Helm Push
  run: |
    ...
    helm push \${CHART_NAME}-\${ENVIRONMENT}-\${NEW_VERSION}.tgz oci://$OCI_REGISTRY`})})]}),(0,t.jsx)("h2",{className:"h3 mt-5 mb-3 text-info",children:"Job 3: Update Environment Values"}),(0,t.jsxs)("p",{className:"text-secondary",children:["A dedicated ",(0,t.jsx)("code",{children:"oci"})," branch stores environment-specific values files. This separation allows different configurations per environment while keeping the main branch clean."]}),(0,t.jsxs)("div",{className:"terminal-card my-4",children:[(0,t.jsxs)("div",{className:"terminal-header",children:[(0,t.jsx)("div",{className:"terminal-dot terminal-dot-red"}),(0,t.jsx)("div",{className:"terminal-dot terminal-dot-yellow"}),(0,t.jsx)("div",{className:"terminal-dot terminal-dot-green"}),(0,t.jsx)("span",{className:"ms-3 text-secondary small",children:"Update environment values"})]}),(0,t.jsx)("div",{className:"terminal-body",children:(0,t.jsx)("pre",{className:"text-success mb-0",children:`update-env-values:
  ...
  steps:
    - uses: actions/checkout@v4
      with:
        ref: oci  # Dedicated branch for env configs
...
git tag oci-dev-$(date +%Y%m%d-%H%M%S)
git push origin --tags

# Deploy to staging
git tag oci-staging-v1.2.3
git push origin --tags

# Deploy to production
git tag oci-prod-release-2025-01
